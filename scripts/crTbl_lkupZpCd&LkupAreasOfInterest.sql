...
-- 
-- 1. This DDL creates table LKUP_COUNTY_ZIP_CITY.
-- 2. The data for this table was downloaded from the webpage
--    "https://data.mo.gov/Geography/Missouri-Zip-Codes-by-County-City/im7g-fucq"
-- 3. The data dump was created in (pipe-delimited) file "cntyZpCt_pipDlm.csv"
--    at directory path "C:\aData\clntsPrjcts\RgnlDtAlnce\dtaRsrcs\othrDta"
--
CREATE TABLE 
...
-- 3. The data for this was created manually - using the resources listed above.
