...
'This table contains the covid case count (and corresponding rate) data, for STL city, from file "s3://uw211dashboard-workbucket/covid_zip_stl_city.csv" that was fetched from ... .'
;
...
'This table contains the covid case count (and corresponding rate) data, for STL county, from file "s3://uw211dashboard-workbucket/covid_zip_stl_county.csv" that was fetched from ... .'
;
