...
(report_date         DATE,
 ...
 PRIMARY KEY (report_date, state_nm, county_nm, geo_id)
);
...
The data for this table was consolidated from the staging tables - STG_COVID_DLY_VIZ_CNTY_ALL, STG_COVID_ZIP_STL_CounTY, and STG_COVID_ZIP_STL_CiTY.
